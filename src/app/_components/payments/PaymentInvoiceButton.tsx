    ...
    <>
      <div className="w-full flex flex-col gap-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            onClick={() => {
              handleClick(PaymentMethodEnum.STARS)
            }}
            disabled={isLoading}
            className={`grow py-2 px-4 rounded-md bg-[var(--star-container-rgba)]  transition-all duration-200 hover:brightness-110 active:scale-[0.97] ${
              isLoading ? 'opacity-50 cursor-not-allowed' : ' cursor-pointer'
            } flex gap-2 items-center justify-center font-bold font-mono text-sm`}>
          ...
          {rates && (
            <button
              onClick={() => {
                handleClick(PaymentMethodEnum.TON_TON)
              }}
              disabled={isLoading}
              className={`grow py-2 px-4 rounded-md bg-[var(--ton-container-rgba)]  transition-all duration-200 hover:brightness-110 active:scale-[0.97] ${
                isLoading ? 'opacity-50 cursor-not-allowed' : ' cursor-pointer'
              } flex gap-2 items-center justify-center font-bold font-mono text-sm`}>
